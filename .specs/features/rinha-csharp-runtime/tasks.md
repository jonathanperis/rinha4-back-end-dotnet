...
| T3 | Review staged scope before commit/push | `git diff --staged` matches requested scope; large generated artifacts use LFS/artifact/image-build strategy |
...
| T11 | Execute competitor gap analysis plan | `.specs/features/competitor-gap-analysis/results.md` records verdicts |
