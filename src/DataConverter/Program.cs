...
static int VectorGroup(JsonElement vector)
{
    // Converter must use the exact same bucket key as WebApi, otherwise the
    // startup majority table would point at wrong vector ranges.
