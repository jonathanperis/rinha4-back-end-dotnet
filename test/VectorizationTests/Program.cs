...
internal static class IvfRepairAssertions
{
    ...
    public static void AssertBoundaryRepair(string path, byte firstPassFrauds, byte repairFrauds, byte expectedFastOnly, byte expectedRepaired)
    {
        ...
        byte fastOnly = index.FraudCount(quantized, new IvfSearchOptions(1, 1, false, false, 1, 4, 5_000_000, 0, 0, 0, 0, 4_500_000));
        byte repaired = index.FraudCount(quantized, new IvfSearchOptions(1, 1, true, true, 1, 4, 5_000_000, 0, 0, 0, 0, 4_500_000));
